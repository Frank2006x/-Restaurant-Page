...
export default function () {
  const item1 = new menu_card(
    'Burger',
    'Juicy, savory, grilled, delicious, satisfying.',
    3,
    burgerImg
  )
  const item2 = new menu_card(
    'Pizza',
    'Cheesy, crispy, savory, flavorful, irresistible.',
    7,
    pizzaImg
  )
  const item3 = new menu_card(
    'Noodles',
    'Steamy, flavorful, savory, tender, satisfying.',
    4,
    noodleImg
  )
  const item4 = new menu_card(
    'Shawama',
    'Spicy, savory, tender, flavorful, delicious.',
    3.5,
    shawamaImg
  )
}
