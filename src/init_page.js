...
export default function () {
  ...
  text1.textContent =
    "Experience the perfect blend of flavors, ambiance, and hospitality at Guki's kitchen. Nestled in the heart of Chennai, we take pride in serving mouthwatering dishes made with the freshest ingredients and a touch of culinary excellence."
  text2.textContent =
    "From sizzling appetizers to delightful desserts, our menu is thoughtfully crafted to satisfy every craving. Whether you're in the mood for classic comfort food or gourmet delicacies, our chefs bring passion and creativity to every plate."
